...
def PDM_precise(t, y, period, name='none', precision=0.01, nbins=15, covers=3):
    ...
    P = pyPDM.PyPDM(t, y)
    print "Trying fit..."
    f1, t1 = P.pdmEquiBinCover(nbins, 3, S)
...
#    pp = pp - phaseshift
    ...
    """
    plt.show()
    return revised_period, t1[best_fit_idx]

def PDM_equibin(t, y, period, name='none', precision=0.001, nbins=15):
    ...
    best_fit_idx = t2.argmin()
    revised_period = f2[best_fit_idx]
    print "Best fit period:", revised_period
...
def PDM_equibincover(t, y, period, name='none', precision=0.001, nbins=15, covers=3):
